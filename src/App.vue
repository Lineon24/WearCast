...
// 🛠️ 트러블슈팅: 처음엔 아이콘을 이모지(📋ℹ️⭐🤖)로 썼는데, 브라우저/OS마다 이모지 색·굵기가
...
/* 🛠️ 트러블슈팅: 처음엔 로고를 위 줄, 메뉴+단위 스위치를 아래 줄로 나눠서(column) 배치했는데,
...
/* 🛠️ 트러블슈팅: 원래 flex: 1이었는데, 그러면 메뉴 4개짜리 배경(연한 회색 알약)이
...
/* 🛠️ 트러블슈팅: 라벨 글자 수가 달라서("소개"/"챗봇" 2글자 vs "대시보드"/"즐겨찾기" 4글자)
